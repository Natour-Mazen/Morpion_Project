...
void WhatisTheSymbol(TPlayer playerX, TPlayer playerO)
{
    if(playerX.typejoueur == Humain && playerO.typejoueur == IA){
        messageSDL("Symbole de jeu",">> Cette partie est Humain vs IA, vous jouez actuellement avec les croix !");
    }
    else if(playerO.typejoueur == Humain && playerX.typejoueur == IA){
        messageSDL("Symbole de jeu",">> Cette partie est Humain vs IA, vous jouez actuellement avec les ronds !");
    }
    else if (playerO.typejoueur == Humain && playerX.typejoueur == Humain){
        messageSDL("Symbole de jeu",">> Cette partie est Humain vs Humain, choissisez vos symbols !");
    }
    else{
        messageSDL("Symbole de jeu",">> Cette partie est IA vs IA, vous ne pouvez pas jouer !");
    }
}
